  ...
  return (
    <div style={{ minHeight: "100vh", background: "#000", color: "#fff" }}>
      ...
      <nav style={{ borderBottom: "1px solid #111", padding: "0 40px" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: "64px" }}>
          ...
          <div style={{ display: "flex", gap: "24px", alignItems: "center" }}>
            <Link href="/login" style={{ fontFamily: "'Courier New', monospace", fontSize: "11px", textTransform: "uppercase", letterSpacing: "0.1em", color: "#666", textDecoration: "none" }}>Sign in</Link>
            <Link href="/signup" style={{ fontFamily: "'Courier New', monospace", fontSize: "11px", textTransform: "uppercase", letterSpacing: "0.1em", background: "#fff", color: "#000", padding: "10px 20px", textDecoration: "none", fontWeight: 700 }}>Get started →</Link>
          </div>
        </div>
      </nav>
      ...
      <section style={{ maxWidth: "1100px", margin: "0 auto", padding: "120px 40px 100px" }}>
        <div style={{ fontFamily: "'Courier New', monospace", fontSize: "11px", letterSpacing: "0.2em", textTransform: "uppercase", color: "#555", marginBottom: "24px" }}>// Massachusetts property intelligence</div>
        <h1 style={{ fontSize: "clamp(36px, 6vw, 72px)", fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 1.05, margin: "0 0 32px", maxWidth: "800px" }}>
          Find motivated sellers<br />before anyone else does.
        </h1>
        <p style={{ fontSize: "20px", color: "#999", lineHeight: 1.6, maxWidth: "560px", margin: "0 0 48px" }}>
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1px", background: "#111" }}>
          {[
            ...
            <div key={i} style={{ background: "#000", padding: "48px 40px" }}>
              ...
              <div style={{ fontFamily: "'Courier New', monospace", fontSize: "11px", textTransform: "uppercase", letterSpacing: "0.15em", color: "#555" }}>{s.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ maxWidth: "1100px", margin: "0 auto", padding: "100px 40px" }}>
        <div style={{ fontFamily: "'Courier New', monospace", fontSize: "11px", letterSpacing: "0.2em", textTransform: "uppercase", color: "#555", marginBottom: "48px" }}>// what you get</div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "1px", background: "#111" }}>
          {[
            ...
            <div key={i} style={{ background: "#000", padding: "40px" }}>
              <div style={{ fontFamily: "'Courier New', monospace", fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.2em", color: "#555", marginBottom: "16px" }}>0{i+1}</div>
              <h3 style={{ fontSize: "20px", fontWeight: 700, margin: "0 0 12px", letterSpacing: "-0.01em" }}>{f.title}</h3>
              <p style={{ color: "#888", fontSize: "15px", lineHeight: 1.6, margin: 0 }}>{f.body}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ borderTop: "1px solid #111", padding: "100px 40px" }}>
        <div style={{ maxWidth: "480px", margin: "0 auto", textAlign: "center" }}>
          ...
          <Link href="/signup" style={{ display: "block", fontFamily: "'Courier New', monospace", fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.1em", background: "#fff", color: "#000", padding: "18px 32px", textDecoration: "none", fontWeight: 700, textAlign: "center" }}>Get started →</Link>
        </div>
      </section>
      ...
      <footer style={{ borderTop: "1px solid #111", padding: "40px" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ fontFamily: "'Courier New', monospace", fontSize: "11px", color: "#333" }}>© 2026 ZaxScape · Massachusetts property intelligence</div>
          <Link href="/login" style={{ fontFamily: "'Courier New', monospace", fontSize: "11px", color: "#444", textDecoration: "none" }}>Sign in</Link>
        </div>
      </footer>
    </div>
  )
